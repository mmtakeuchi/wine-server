...
daou = Wine.create({brand: 'Daou', nose: 'cherry', taste: 'cherry', varietal_id: 1, origin_id: 1})
chandon = Wine.create({brand: 'Chandon', nose: 'apple', taste: 'pear', varietal_id: 1, origin_id: 47})